    ...
    return (
        <div className={styles.container} onClick={handleOnClick} >
            <ResponsiveContainer width="100%" height="100%">
                ...
                <XAxis dataKey="name" tickFormatter={(name )=>new Date(name).toLocaleTimeString()} interval="preserveStartEnd" minTickGap={24} />
                <Tooltip content={<ChartTool charData={charData} />}/>
